package com.capgemini.devonfw.chirr.general.configuration;
...
import com.capgemini.devonfw.chirr.general.common.impl.security.ApplicationAuthenticationProvider;
import com.capgemini.devonfw.chirr.general.common.impl.security.CsrfRequestMatcher;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    "/services/rest/logout", "/jsclient/**", "/services/rest/security/v1/currentuser" };
    http
        //
