...
ALTER TABLE STREAM ADD CONSTRAINT UC_STREAM_NAME UNIQUE(name);
...
ALTER TABLE FLOW ADD CONSTRAINT PK_FLOW PRIMARY KEY(id);
ALTER TABLE FLOW ADD CONSTRAINT UC_SFLOW_NAME UNIQUE(name);
